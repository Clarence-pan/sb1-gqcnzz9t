        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Join thousands of data-driven organizations that use Xxx to unlock the full potential of their data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Create your account and access your personalized dashboard.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Connect Data</h3>
              <p className="text-gray-600 dark:text-gray-300">Easily connect your data sources with our secure integration tools.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Start receiving actionable insights and recommendations immediately.</p>
            </div>
          </div>

          <div className="bg-blue-600 dark:bg-blue-700 rounded-2xl p-8 md:p-10 text-center text-white shadow-xl">
            <h3 className="text-2xl font-bold mb-4">Start Your Free 14-Day Trial</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex items-center">
                <CheckCircle className="w-5 h-5 mr-2 text-blue-300" />
                <span className="text-blue-100">Full feature access</span>
              </div>
            </div>
          </div>
        </div>
